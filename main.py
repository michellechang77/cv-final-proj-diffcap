...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpus", nargs="+", type=int, help="specify gpus to use")
    ...
    if not args.test and not args.sample:
        if not new_config.training.resume_training:
    ...
    shutil.copy(args.config, os.path.join(args.exp, "config.yaml"))
